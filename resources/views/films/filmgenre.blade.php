...
<body class="bg-black text-white">
    <div class="d-flex">
        ...
        <!-- Main Content -->
        <div class="flex-grow-1" style="margin-left: 250px; height: 100vh; overflow-y: auto;">
            <!-- Navbar -->
            <nav class="navbar navbar-dark bg-black px-3 py-3">
                <div class="mx-auto" style="width: 700px;">
                    <form action="{{ route('genre.films', ['id' => $genre->id]) }}" method="GET" class="position-relative" role="search">
            ...
            <!-- Film Content -->
            <div class="p-4">
                <h4 class="mb-4">{{ $genre->genre }} Films</h4>
